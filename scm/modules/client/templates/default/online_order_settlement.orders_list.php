...
<div class="page">
        ...
        <div class="item-title">
            <a class="back" href="" onclick="window.history.go(-1)" title="返回列表"><i class="fa fa-arrow-circle-o-left"></i></a>
            <div class="subject">
                <h3>订单结算</h3>
                <h5>订单结算及资金流的显示</h5>
            </div>
    ...
    <script>
        $(function () {
            $("#flexigrid").flexigrid({
                url: 'index.php?act=online_order_settlement&op=get_order_xml&settlement_id=<?=$output['settlement_id']?>',
                colModel: [
...
//                rp :1,
        ...
        function fg_sku(order_id,clie_id) {
            ...
            console.log(clie_id);
            _uri = "index.php?act=online_order_settlement&op=show_goods&order_id=" +order_id+"&clie_id="+clie_id;
