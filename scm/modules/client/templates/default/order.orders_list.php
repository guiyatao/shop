...
<div class="page">
    <div class="fixed-bar">
        ...
        <div class="item-title">
            <a class="back"  title="返回列表" href="" onclick="window.history.go(-1)"><i class="fa fa-arrow-circle-o-left"></i></a>
            <div class="subject">
                <h3>订单结算</h3>
                <h5>订单结算及资金流的显示</h5>
            </div>
    ...
    <script>
        $(function () {
            $("#flexigrid").flexigrid({
                url: 'index.php?act=order_settlement&op=get_order_xml&settlement_id=<?=$output['settlement_id']?>&clie_id=<?=$output['clie_id']?>',
                colModel: [
                    ...
                    {display: '取消/退货日期', name: 'pay_start_time', width: 120, sortable: false, align: 'left'},
...
//                rp :1,
        ...
        function fg_sku(id) {
            _uri = "index.php?act=order_settlement&op=show_goods&id=" + id;
