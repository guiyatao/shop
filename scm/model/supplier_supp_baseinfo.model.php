...
class supplier_supp_baseinfoModel extends Model {
     ...
     */
    public function getBaseGoodsInfo($condition , $field = '*'){
        return $this->table('scm_supp_baseinfo')->field($field)->where($condition)->find();
    }
